...
export default function GoogleHomepage({ query, setQuery, onSearch, onSuggestionSearch }: GoogleHomepageProps) {
  return (
      ...
      <div className="flex-1 flex flex-col items-center justify-center -mt-32">
        <div className="text-center">
          ...
          <form onSubmit={onSearch} className="mb-8">
            <div className="max-w-full px-4 sm:max-w-xl mx-auto">
              <SearchSuggest
                query={query}
                onChange={setQuery}
